  ...
  getAuditReport(sessionId: string): unknown {
    ...
    return {
      ...
      rollup: {
        ...
        copilotAiCredits: audit.rollup.copilotAiCredits,
        copilotCostUsd: audit.rollup.copilotCostUsd,
        copilotInputTokens: audit.rollup.copilotInputTokens,
        copilotOutputTokens: audit.rollup.copilotOutputTokens,
        copilotUsageRuntimeCount: audit.rollup.copilotUsageRuntimeCount,
